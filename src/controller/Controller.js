...
class Controller{
     ...
     */
    static validateTheForm(firstName, lastName, email, dateOfBirth, userName, Password){
        return Registration.validateForm(firstName, lastName, email, dateOfBirth, userName, Password);
    }
