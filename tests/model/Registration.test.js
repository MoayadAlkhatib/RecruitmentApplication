...
test('checks if the email adress and the date of birth and username is valid.', ()=>{
    expect(Registration.validateForm('Moayad', 'Moayad', 'user17@gmail.com', '20000101', 'mooo').length)
    .toBe(0);
})
